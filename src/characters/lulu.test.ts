...
test("噜噜配置提供现有素材对应的基础动作", () => {
  ...
  assert.equal(lulu.actions.walk.asset, "跑步.processed.png");
  assert.equal(lulu.actions.walk.frameCount, 9);
  assert.equal(lulu.actions.wave.asset, "打招呼.processed.png");
